...
public interface ReservationMapper {
    @Mapping(source = "startDt", target = "reservationStartDt")
    @Mapping(source = "endDt", target = "reservationEndDt")
    ...
    Reservation toEntity(ReservationRequestDto reservationRequestDto, LocalDateTime startDt, LocalDateTime endDt, Space space, MemberInfo memberInfo);
