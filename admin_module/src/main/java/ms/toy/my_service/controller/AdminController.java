...
public class AdminController {
    ...
    @GetMapping
    public ResponseEntity<Object> searchAdmin(@ParameterObject @ModelAttribute AdminSearchCondition searchCondition) {
        return ResponseEntity.ok(adminService.searchAdmin(searchCondition));
    }
