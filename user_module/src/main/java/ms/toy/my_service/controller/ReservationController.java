...
public class ReservationController {
    ...
    public ResponseEntity<Object> cancelReservation(
        ...
        return ResponseEntity.ok(reservationService.cancelReservation(id, SiteType.USER, memberInfo));
    }
    ...
    public ResponseEntity<Object> editReservation(
            ...
            @AuthenticationPrincipal MemberInfo memberInfo) {
        return ResponseEntity.ok(reservationService.editReservation(id, reservationEditDto, SiteType.USER, memberInfo));
    }
